...
<%@page import="org.zerock.tourist.member.domain.MemberVO" %>
<%@page import="org.zerock.tourist.member.dao.MemberDAO" %>
<!DOCTYPE html>
<html lang="ko">
<head>
				...
				<fieldset>
					...
					<ul class="app_list">
						...
						<li class="clear">
							...
							<div class="app_content"><input type="text" name="member_id" class="w100p" id="name_lbl" placeholder="이름을 입력해주세요"/></div>
						</li>
						<li class="clear">
						...
						<li class="clear">
							...
							<div class="app_content"><input type="password" name="name" class="w100p" id="pwd2_lbl" placeholder="비밀번호를 다시 한번 입력해주세요"/></div>
						</li>
						<li class="clear">
