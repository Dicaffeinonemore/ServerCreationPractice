...
<div id="wrap">
    ...
    <div id="container">
        ...
        <div class="bodytext_area box_inner">
            <form action="/notice/list" method="get" class="minisrch_form">
                <fieldset>
                    <legend>검색</legend>
...
<%--                <a href="javascript:;" class="firstpage  pbtn"><img src="/resources/img/btn_firstpage.png" alt="첫 페이지로 이동"></a>--%>
                ...
                <c:forEach begin="${pageResponseDTO.start}" end="${pageResponseDTO.end}" var="num">
                    <a href="javascript:;"><span class="pagenum ${pageResopnseDTO.page == num ? "currentpage": ""}" data-num="${num}">${num}</span></a>
                </c:forEach>
...
<script>
    document.querySelector(".pagination").addEventListener("click",(e)=>{
        ...
        console.log("asd",${pageResopnseDTO});
